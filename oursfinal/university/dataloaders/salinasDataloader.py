...
#         print('bands_matrix',bands_matrix.shape)
        bands_matrix = bands_matrix.transpose((2,0,1))
#         print('bands_matrix',bands_matrix.shape)
...
#         '/mnt/SGT-main/datasets/salinas/Salinas_corrected.mat',
#         '/mnt/SGT-main/datasets/salinas/Salinas_gt.mat')
    nbands, nrows, ncols, X_train, X_test, y_train, y_test, zerodata = load_train(
        '/mnt/oursfinal/datasets/salinas/Salinas_corrected.mat',
        '/mnt/oursfinal/datasets/salinas/Salinas_gt.mat')

    train_dataset = Dataset_salinas(np.array(X_train), np.array(y_train))
    train_dataloader = DataLoader(dataset=train_dataset, batch_size=batch_size, shuffle=False, num_workers=8)
